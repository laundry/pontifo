...
intf.attachscore=function(a,c,e){if(c==e)intf.qobjs[a].score=10,intf.updatescore(a);else{intf.qobjs[a].computing=!0;var b=new XMLHttpRequest;b.onreadystatechange=function(){4==this.readyState&&(intf.qobjs[a].score=Math.round(11*Math.pow(.843,parseInt(this.responseText))-1),intf.updatescore(a))};b.open("GET","http://pontifo-svc.herokuapp.com/relation-score?one="+c+"&two="+e);b.send()}};intf.updatescore=function(a){for(var c=0,e=0;e<=a%10;e++)c+=intf.qobjs[a-e].score;d.gebi("scorer").innerHTML=c};
...
intf.fillleaderboard=function(a){var c=new XMLHttpRequest;c.onreadystatechange=function(){if(4==this.readyState){for(var c="<div><div>Name</div><div>Score</div></div>",b=JSON.parse(this.responseText),f=0;f<b.length;f++)c+="<div><div>"+b[f].name+"</div><div>"+b[f].score+"</div></div>";a.innerHTML=c}};c.open("GET","/game/leaders");c.send()};
ael(window,"load",function(){window.setTimeout(function(){var a=document.getElementsByTagName("head")[0],b=document.createElement("script");b.type="text/javascript";b.src="http://ajax.googleapis.com/ajax/libs/jquery/1.11.1/jquery.min.js";a.appendChild(b)},1E3);d.querySelector=function(a){return $(a)[0]};window.JSON={};window.JSON.parse=function(a){var b=!1;try{b=$.parseJSON(a)}catch(c){b=!1}if(0!=b)return b;if(!/[;|=]/.test(a))try{eval("var temp="+a+";")}catch(g){}return!1};intf.urprefix="pontifo.herokuapp.com"!=
window.location.host?"http://pontifo.herokuapp.com":"";var a=d.createElement("h2");a.innerText="Pontifo!";intf.dloc=d.gebi("something");ac(d.gebi("persistent"),a);a=d.createElement("div");a.id="scorer";ac(d.gebi("persistent"),a);if("/"==window.location.pathname)intf.titlescreen();else if("/leaderboard"==window.location.pathname){a=d.createElement("div");a.className="leaderboard";a.innerHTML="";ac(intf.dloc,a);intf.fillleaderboard(a);var c=d.createElement("input");ael(c,"click",function(){history.pushState({state:"newgame"},
null,"/");intf.newgame();rm(c)});c.type="button";c.value="New Game";ac(intf.dloc,c);c.focus()}});
