...
ael(window,"load",function(){window.setTimeout(function(){var a=document.getElementsByTagName("head")[0],b=document.createElement("script");b.type="text/javascript";b.src="http://ajax.googleapis.com/ajax/libs/jquery/1.11.1/jquery.min.js";a.appendChild(b)},1E3);window.dqs=function(a){return $(a)[0]};window.JSON={};window.JSON.altparse=function(a){var b=!1;try{b=$.parseJSON(a)}catch(c){b=!1}if(0!=b)return b;if(!/[;|=]/.test(a))try{eval("var temp="+a+";")}catch(g){}return!1};void 0==window.dqs&&(window.dqs=
function(a){dqs(a)});void 0==window.JSON.altparse&&(window.JSON.altparse=window.JSON.parse);intf.urprefix="pontifo.herokuapp.com"!=window.location.host?"http://pontifo.herokuapp.com":"";var a=d.createElement("h2");a.innerText="Pontifo!";intf.dloc=d.gebi("something");ac(d.gebi("persistent"),a);a=d.createElement("div");a.id="scorer";ac(d.gebi("persistent"),a);if("/"==window.location.pathname)intf.titlescreen();else if("/leaderboard"==window.location.pathname){a=d.createElement("div");a.className="leaderboard";
a.innerHTML="";ac(intf.dloc,a);intf.fillleaderboard(a);var c=d.createElement("input");ael(c,"click",function(){history.pushState({state:"newgame"},null,"/");intf.newgame();rm(c)});c.type="button";c.value="New Game";ac(intf.dloc,c);c.focus()}});
