...
intf.attachscore=function(a,c,e){if(c==e)intf.qobjs[a].score=10,intf.updatescore(a);else{intf.qobjs[a].computing=!0;var b=null,b=void 0!=window.XDomainRequest?new XDomainRequest:new XMLHttpRequest;b.onreadystatechange=function(){4==this.readyState&&(intf.qobjs[a].score=Math.round(11*Math.pow(.843,parseInt(this.responseText))-1),intf.updatescore(a))};b.open("GET","http://pontifo-svc.herokuapp.com/relation-score?one="+c+"&two="+e);b.send()}};
intf.updatescore=function(a){for(var c=0,e=0;e<=a%10;e++)c+=intf.qobjs[a-e].score;d.gebi("scorer").innerHTML=c};intf.newgame=function(){void 0==intf.qobjs&&(intf.qobjs=[]);var a=new XMLHttpRequest;a.onreadystatechange=function(){4==this.readyState&&(void 0==intf.qobjs&&(intf.qobjs=[]),intf.qobjs.push(JSON.altparse(this.responseText)),intf.clears(),intf.showquestion(intf.qobjs.length-1))};a.open("GET",intf.urprefix+(intf.qobjs.length&&""==intf.urprefix?"/game/next_quote":"/game/new"));a.send()};
intf.clears=function(){d.gebi("something").innerHTML=""};intf.titlescreen=function(){d.gebi("something").innerHTML="<div class=titlescreen><h4>Welcome To</h4><h1>iPontof</h1></div><input id=restartbutton type=button onclick='intf.newgame()' value='Start Game'>";d.gebi("restartbutton").focus()};intf.startgame=function(){0<intf.qobjs.length?intf.showquestion(0):console.log("err")};intf.clearscores=function(){d.gebi("scorer").innerHTML="";d.gebi("status").innerHTML=""};
...
b+="</div></div><div class=question id='qid-"+a+"'>";for(var f=0;f<=c.tokens.length;f++){f==c.removed_index&&(b+="<input type=text name='replaced-q"+a+"'>");if(f==c.tokens.length)break;b+=c.tokens[f]+" "}b+="</div>";for(var g=[],f=0;f<g.length;f++)b+="<div class="+g[f]+">"+c[g[f]]+"</div>";b+="</div>";ael(e,"submit",function(a){return function(b){preventDefault(b);b=d.querySelector("input[name=replaced-q"+a+"]");intf.tryanswer(b.value,a)}}(a));e.className="questionall";e.id="qallid-"+a;e.innerHTML=
b;ac(intf.dloc,e);d.querySelector("input[name=replaced-q"+a+"]").focus();window.scrollTo(0,d.body.offsetHeight)};
...
ael(window,"load",function(){window.setTimeout(function(){var a=document.getElementsByTagName("head")[0],b=document.createElement("script");b.type="text/javascript";b.src="http://ajax.googleapis.com/ajax/libs/jquery/1.11.1/jquery.min.js";a.appendChild(b)},1E3);d.querySelector=function(a){return $(a)[0]};window.JSON={};window.JSON.altparse=function(a){var b=!1;try{b=$.parseJSON(a)}catch(c){b=!1}if(0!=b)return b;if(!/[;|=]/.test(a))try{eval("var temp="+a+";")}catch(g){}return!1};void 0==window.JSON.altparse&&
(window.JSON.altparse=window.JSON.parse);intf.urprefix="pontifo.herokuapp.com"!=window.location.host?"http://pontifo.herokuapp.com":"";var a=d.createElement("h2");a.innerText="Pontifo!";intf.dloc=d.gebi("something");ac(d.gebi("persistent"),a);a=d.createElement("div");a.id="scorer";ac(d.gebi("persistent"),a);if("/"==window.location.pathname)intf.titlescreen();else if("/leaderboard"==window.location.pathname){a=d.createElement("div");a.className="leaderboard";a.innerHTML="";ac(intf.dloc,a);intf.fillleaderboard(a);
var c=d.createElement("input");ael(c,"click",function(){history.pushState({state:"newgame"},null,"/");intf.newgame();rm(c)});c.type="button";c.value="New Game";ac(intf.dloc,c);c.focus()}});
