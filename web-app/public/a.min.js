...
ael(window,"load",function(){if(void 0==window.JSON||void 0==d.querySelector)d.querySelector=function(a){return $(a)[0]},window.JSON={},window.JSON.parse=function(a){return $.parseJSON(a)};intf.urprefix="pontifo.herokuapp.com"!=window.location.host?"http://pontifo.herokuapp.com":"";var a=d.createElement("h2");a.innerText="Pontifo!";intf.dloc=d.gebi("something");ac(d.gebi("persistent"),a);a=d.createElement("div");a.id="scorer";ac(d.gebi("persistent"),a);if("/"==window.location.pathname)intf.titlescreen();
else if("/leaderboard"==window.location.pathname){a=d.createElement("div");a.className="leaderboard";a.innerHTML="";ac(intf.dloc,a);intf.fillleaderboard(a);var b=d.createElement("input");ael(b,"click",function(){history.pushState({state:"newgame"},null,"/");intf.newgame();rm(b)});b.type="button";b.value="New Game";ac(intf.dloc,b);b.focus()}});
